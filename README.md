...
## Live Application
You can access the live application [here](https://car-advertisement-rodw.onrender.com/)
## Description
This application displays analysis for a dataset of used vehicles for sale.
## Installation
To run the application locally, follow these steps:

1. Clone the repository:
   ```bash
   git clone https://github.com/michav95/Car-Advertisement
   ```
2. Navigate to the project directory:
   ```bash
   cd Car-Advertisement
   ```
